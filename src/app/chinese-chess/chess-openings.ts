import { Position, PlayerColor, PieceType, ChessPiece } from './chess-piece.interface';
...
// 開局庫 - 包含經典開局及其變化
export const OPENING_LIBRARY: { [key: string]: Array<{ moves: string[], popularity: number, winRate: number }> } = {
  // 中炮開局系列
  '中炮': [
    {
...
export const STANDARD_RESPONSES: { [key: string]: Array<{ from: Position, to: Position, description: string }> } = {
  // 紅方中炮開局的黑方應對
  '炮二平五': [
